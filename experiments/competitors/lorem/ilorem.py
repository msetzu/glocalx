...
from explanation import ImageExplanation
from decision_tree import learn_local_decision_tree
from ineighgen import ImageLimeGenerator
...
class ILOREM(object):
    ...
    def __init__(self, K, bb_predict, class_name, class_values, neigh_type='lime', ocr=0.1,
                 segmentation_type='quickshift', param1_gen_method2=True, param2_gen_method2=1000,
    ...
    def explain_instance(self, img, num_samples=1000, use_weights=True, metric='cosine', hide_color=None):
        ...
        crules, deltas = get_counterfactual_rules(x, Yc[0], dt, Z, Yc, self.feature_names, self.class_name,
                                                  self.class_values, self.feature_names, False)
    ...
    def __init_neighbor_fn(self, kwargs):
        ...
        if self.neigh_type in ['lime']:
            segmentation_type = kwargs.get('segmentation_type', 'quickshift')

            neighgen = ImageLimeGenerator(self.bb_predict, ocr=self.ocr, segmentation_type=segmentation_type)
        else:
